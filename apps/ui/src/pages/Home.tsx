...
export default function Home() {
    return (
      <div className="flex flex-col items-center bg-dominant h-full w-full">
        ...
        <h2 className="mt-7 w-1/2 text-2xl text-center text-gray-600">Desde festivales hasta casamientos, encuentra o crea el evento perfecto. Gestiona inscripciones, pagos y más en un solo lugar.</h2>
        <TopEvents></TopEvents>
        <Stats></Stats>
      </div>
    );
