    ...
    <div className="bg-transparent w-[80%] mt-28">
      ...
      <div className="bg-transparent w-full flex flex-col justify-center items-center mt-10">
        <div className="bg-transparent w-full flex flex-row justify-center items-center">
          <div className="relative w-1/3 h-60 border border-complement/30 rounded-2xl flex flex-col justify-center items-center m-4 bg-white">
            {/* Círculo con el número */}
            <div className="absolute -top-3 left-1/2 -translate-x-1/2">
              <div className="flex justify-center items-center text-center rounded-full h-9 w-9 bg-accent text-white text-md font-bold">
                01
              </div>
            </div>

            <div className="w-16 h-16 bg-complement/30 rounded-full flex justify-center items-center text-center mt-10">
